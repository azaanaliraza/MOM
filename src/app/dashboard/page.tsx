...
export default function AdvancedDashboard() {
  ...
  // Use new keys: thirtyDayPlan, brand, weeklyThemes
    ...
    <div className="min-h-screen bg-[#FDFDFF] pb-32 selection:bg-indigo-100 selection:text-indigo-900">
      <nav className="bg-white/70 backdrop-blur-xl border-b border-stone-100 px-8 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-64 bg-white border border-stone-100 shadow-2xl rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 overflow-hidden">
              ...
              <a href="/" className="flex items-center gap-2 px-6 py-5 text-[10px] font-black text-indigo-600 bg-indigo-50/50 hover:bg-indigo-50 transition-colors uppercase tracking-widest border-t border-indigo-100/30">
                <Plus size={10} /> Launch New Roadmap
              </a>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-8 pt-12">
        ...
        <div className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
            <div>
                <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100">
              ...
              {thirtyDayPlan.map((step: any) => (
                <button 
                  ...
                  className={`min-w-[150px] p-7 rounded-[2.5rem] border text-left transition-all duration-300 relative group ${
                    activeDay === step.day ? 'bg-indigo-600 border-indigo-500 text-white shadow-2xl scale-105 -translate-y-1' : 'bg-white border-stone-100 hover:border-indigo-200 shadow-sm'
                  }`}
                >
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center mb-5 transition-colors ${
                    activeDay === step.day ? 'bg-white/20 text-white' : 'bg-stone-50 text-indigo-600 group-hover:bg-indigo-50'
                  }`}>
